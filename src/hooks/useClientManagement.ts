...
export const useClientManagement = () => {
      ...
      if (data) {
        const formattedContacts: Contact[] = data.map(client => {
          ...
          return {
            ...
            ChatName: client.nome_Chat,
            ChatSize: client.porte_Chat,
            ChatBreed: client.raca_Chat,
        ...
        .insert([
          {
            ...
            nome_Chat: newContact.ChatName,
            porte_Chat: newContact.ChatSize,
            raca_Chat: newContact.ChatBreed,
  ...
  const openEditModal = () => {
    ...
    setNewContact({
      ...
      ChatSize: selectedContact.ChatSize,
      ChatBreed: selectedContact.ChatBreed,
