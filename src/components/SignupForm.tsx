...
import { ShipWhell
, Mail, Lock, Eye, EyeOff, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full button-hover-effect bg-Valore-gold hover:bg-amber-500 text-Valore-blue font-bold py-3 px-4 rounded-md flex items-center justify-center transition-all duration-300"
      >
        {isLoading ? (
          <div className="h-5 w-5 border-2 border-Valore-blue border-t-transparent rounded-full animate-spin mr-2"></div>
        ) : (
          <ShipWhell
