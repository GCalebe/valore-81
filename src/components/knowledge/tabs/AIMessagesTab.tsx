...
const AIMessagesTab = () => {
  ...
  const [messages, setMessages] = useState<AIMessage[]>([
    {
      ...
      content: 'Olá! Sou o {assistantName} e estou aqui para ajudá-lo. Como posso auxiliá-lo hoje?',
    ...
    },
    {
      ...
      content: 'Olá, {userName}! É um prazer falar com você novamente. Em que posso ajudá-lo hoje?',
      variables: ['userName'],
    ...
    },
    {
      ...
      content: 'Desculpe, não consegui entender sua solicitação. Poderia reformular sua pergunta?',
      variables: [],
    ...
    },
    {
      ...
      content: 'Vou transferir você para um de nossos especialistas que poderá ajudá-lo melhor. Um momento, por favor.',
      variables: [],
    ...
    },
    {
      ...
      content: 'Estou processando sua solicitação. Por favor, aguarde um momento...',
      variables: [],
  ...
  const handleAddMessage = () => {
    ...
    setNewMessage({ category: activeCategory, name: '', content: '', variables: '', context: '' });
            ...
            <div className="space-y-4">
              {getMessagesByCategory(category.id).length === 0 ? (
                <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                  ...
                  <h3 className="text-lg font-medium mb-1">Nenhuma mensagem em {category.name}</h3>
                  <p className="text-sm">Adicione mensagens para esta categoria.</p>
                </div>
              ) : (
