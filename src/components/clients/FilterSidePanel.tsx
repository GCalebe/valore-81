...
const FilterCategory = ({
  ...
  return (
    <Collapsible
      ...
      className="w-full border rounded-md mb-3"
    >
          ...
          <TabsContent value="quick" className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge
                  variant={
                    lastContactFilter === "today" ? "default" : "outline"
                  }
                  className="cursor-pointer"
                ...
                <Badge
                  variant={
                    lastContactFilter === "month" ? "default" : "outline"
                  }
                  className="cursor-pointer"
                ...
                <Badge
                  variant={
                    lastContactFilter === "older" ? "default" : "outline"
                  }
                  className="cursor-pointer"
