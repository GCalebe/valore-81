...
const ClientsCompactToggler: React.FC<ClientsCompactTogglerProps> = ({ isCompactView, setIsCompactView, visible }) => {
    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          ...
          >
            {isCompactView ? <Maximize2 className="h-4 w-4 text-white" /> : <Minimize2 className="h-4 w-4 text-white" />}
          </Button>
        </TooltipTrigger>
        <TooltipContent>
