        ...
        <div className="p-4">
          <Tabs defaultValue="info">
            ...
            <TabsContent value="Chat" className="mt-4 space-y-4">
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Nome do Chat</h3>
                <p>{selectedConversation?.ChatName || 'Não informado'}</p>
              </Card>
              
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Porte</h3>
                <p>{selectedConversation?.ChatType || 'Não informado'}</p>
              </Card>
              
              <Card className="p-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Tipo</h3>
                <p>{selectedConversation?.ChatBreed || 'Não informado'}</p>
              </Card>
            </TabsContent>
          </Tabs>
        </div>
