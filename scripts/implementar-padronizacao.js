...
const COMPONENT_MAPPING = [
  {
    original: "ClientInfoTabs.tsx",
    standardized: "ClientInfoTabsStandardized.tsx",
    phase: "Fase 1: Tela de Chat",
  },
  {
    original: "ClientDetailSheet.tsx",
    standardized: "ClientDetailSheetStandardized.tsx",
    phase: "Fase 2: Tela de Detalhes",
  },
  {
    original: "ClientsTable.tsx",
    standardized: "ClientsTableStandardized.tsx",
    phase: "Fase 3: Tabela de Clientes",
  },
  {
    original: "EditClientDialog.tsx",
    standardized: "EditClientFormStandardized.tsx",
    phase: "Fase 4: Formulário de Edição",
  },
  {
    original: "NewClientDialog.tsx",
    standardized: "NewClientFormStandardized.tsx",
    phase: "Fase 4: Formulário de Criação",
  },
];
...
function implementPhase(phase) {
  ...
  components.forEach((component) => {
    ...
    if (!fileExists(standardizedPath)) {
      console.log(
        `Arquivo padronizado não encontrado: ${component.standardized}`,
      );
      return;
    }

    console.log(
      `Substituindo ${component.original} por ${component.standardized}...`,
    );
...
function main() {
  ...
  console.log(
    "Cada fase substituirá os componentes originais pelos componentes padronizados.",
  );
  console.log(
    "Backups dos arquivos originais serão criados antes da substituição.",
  );
  ...
  rl.question(
    '\nDigite o número da fase que deseja implementar (ou "todas" para implementar todas as fases): ',
    (answer) => {
      ...
      console.log(
        "Caso encontre problemas, você pode restaurar os backups renomeando os arquivos .bak.",
      );
